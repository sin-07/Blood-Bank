      ...
      <AnimatePresence>
        {menuOpen && (
          <>
            ...
            {/* Sidebar */}
            <motion.div
              className="fixed top-0 right-0 h-full w-72 sm:w-80 bg-linear-to-b from-white via-red-50/30 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 shadow-2xl z-56 md:hidden"
            ...
            >
              {/* Sidebar Header */}
              <div className="flex items-center justify-between p-6 border-b border-red-100 dark:border-red-900/30">
              ...
              <div className="flex flex-col py-6 px-4">
                {navLinks.map((link, i) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        className="w-10 h-10 rounded-lg bg-linear-to-br from-red-100 to-red-200 dark:from-red-900/40 dark:to-red-800/40 flex items-center justify-center group-hover:from-red-500 group-hover:to-red-600 transition-all duration-300 shadow-sm"
              ...
              {/* Sidebar Footer */}
              <motion.div
                className="absolute bottom-0 left-0 right-0 p-6 border-t border-red-100 dark:border-red-900/30"
